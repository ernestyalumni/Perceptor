...
\part{Embedded Linux: toolchains, bootloaders}

\section{Toolchains}

cf. Vasquez and Simmonds (2021) \cite{VaSi2021}

\subsection{crosstool-ng}

\subsubsection{Using menuconfig of crosstool-ng}

Do either \\
\verb|./ct-ng menuconfig| or \verb|bin/ct-ng menuconfig| to enter the menu system. Vasquez and Simmonds (2021) \cite{VaSi2021} then refers to Ch. 4 "Configuring and Building the Kernel" for more on menuconfig.

Specific to building a toolchain for Beaglebone Black, \\
For crosstool-ng-1.22.0, the 2 configuration changes recommended are
\begin{itemize}
	\item In \textbf{Paths and misc options}, disable \textbf{Render the toolchain read-only} (\verb|CT_INSTALL_DIR_RO|)
\end{itemize}
...
\bibitem{VaSi2021}
Frank Vasquez, Chris Simmonds. \textbf{Mastering Embedded Linux Programming} - Third Edition. May 2021. Packt 
